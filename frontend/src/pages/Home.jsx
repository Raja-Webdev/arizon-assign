  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-1 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl flex flex-col items-center justify-center h-[90vh]">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              Discover Your Next Favorite Purchase
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Explore curated collections, limited-time deals, and seamless
              shopping. From fashion to tech, find what you love—delivered fast,
              with free returns.
            </p>
